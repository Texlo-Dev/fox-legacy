        ...
        <nav class="level">
          <div class="level-item has-text-centered">
            <figure class="image is-48x48">
              <img v-if="$store.state.cachedGuild.icon" :src="`https://cdn.discordapp.com/icons/${$store.state.cachedGuild.id}/${$store.state.cachedGuild.icon}.jpg?size=128`" class="is-rounded">
