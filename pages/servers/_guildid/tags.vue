  ...
  <section class="section">
    <div class="container">
      <nav class="level is-mobile">
        ...
        <div class="level-left">
          <a class="button is-danger" @click="confirmPkg('Tags')"
        ...
        <div class="column">
          <div class="box">
            <div class="content">
              ...
              <p v-else>
                No tags added. To add a tag, click the "Add Tag" button.
              </p>
            </div>
          </div>
          <div class="box">
            <div class="content">
              ...
              <div class="field">
                <b-checkbox
                  v-model="config.tacMode"
                  type="is-primary"
                  @click.native="settingUpdate('tacMode', !config.tacMode)"
                >
      ...
      <div class="modal-card">
        ...
        <section class="modal-card-body">
          <form id="tag" @submit.prevent="validateForm">
            <b-field
              :type="{ 'is-danger': errors.has('Tag Name') }"
              :message="errors.first('Tag Name')"
              label="Tag Name"
              custom-class="has-text-white"
            >
              <b-input
                v-validate="'required|max:20'"
                v-model="currentag.name"
                name="Tag Name"
              />
            </b-field>
            <b-field
              :type="{ 'is-danger': errors.has('Tag Content') }"
              :message="errors.first('Tag Content')"
              label="Tag Content"
              custom-class="has-text-white"
            >
              <b-input
                v-validate="'required|max:1980'"
                v-model="currentag.content"
                type="textarea"
                name="Tag Content"
              />
            </b-field>
        ...
        <footer class="modal-card-foot">
          ...
          <button class="button is-primary" type="submit" form="tag">
            Add
          </button>
        </footer>
      </div>
