...
export default {
  ...
  methods: {
    async validateWelcome() {
      ...
      if (result)
        return await this.settingArrayUpdate({
          welcomeMsg: this.config.welcomeMsg,
          welcomeLocation: this.config.welcomeLocation
        });
      /* if (result) {
    ...
    async validateGoodbye() {
      ...
      if (result)
        return await this.settingArrayUpdate({
          goodbyeMsg: this.config.goodbyeMsg,
          goodbyeChannel: this.config.goodbyeChannel
        });
      /* if (result) {
