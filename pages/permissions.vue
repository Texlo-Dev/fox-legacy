        ...
        <div class="columns is-centered">
          <div class="column is-one-third">	
            <div class="box">
              ...
              <aside class="menu">
                <ul class="menu-list">
                  <li v-for="(cmd, category) of permissions" :key="category" class="has-text-centered"><a :class="{ 'is-active': activeCat === category }" @click="scrollTo(category)"><p class="has-text-white">{{ category }} </p></a></li>
                </ul>
              </aside>
            </div>			
          </div>
            ...
            <div class="box">
              ...
              <div class="content">
                <b-table :mobile-cards="false" :paginated="willPaginate(activeCat)"
                         ...
                         :data="permissions[activeCat]" :columns="columns" per-page="7" class="has-text-black"/>	
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="section">
      ...
      <div class="container">
        <div class="columns">
          ...
          <div class="column">
            <br><br>
            <img id="columnimg" :src="require('../assets/permselector.png')" align="right">		
          </div>
        </div>
      </div>
      <br>
      <div class="container">
        <div class="columns">
          ...
          <div class="column">
            <br><br>
            <img id="columnimg" :src="require('../assets/setpermcmd.png')" align="right">		
          </div>
        </div>
      </div>
    </section>
