<template>
  <div>
    ...
    <section class="section">
      <div class="container">
        <h1 class="title has-text-white has-text-left">Embed Generator</h1>
      ...
      <div class="container">
        <form id="embed" @submit.prevent="verifyForm">
          <div class="columns">
            <div class="column is-half">
              ...
              <div v-if="mode === 'webhook'">
                <b-field
                  :type="{ 'is-danger': errors.has('Webhook URL') }"
                  :message="errors.first('Webhook URL')"
                  label="Webhook URL"
                  custom-class="has-text-white"
                >
                  <b-input
                    ...
                    v-model="embed.whurl"
                    name="Webhook URL"
                    placeholder="https://discordapp.com/api/webhooks/webhookid/exampletoken"
                  />
                </b-field>
                <br >
              </div>
              <div v-else-if="mode === 'native'">
                <b-field
                  :type="{ 'is-danger': errors.has('Server') }"
              ...
              <b-field
                :type="{ 'is-danger': errors.has('Author Name') }"
                :message="errors.first('Author Name')"
                label="Author"
                custom-class="has-text-white"
              >
                <b-input
              ...
              <b-field
                :type="{ 'is-danger': errors.has('Field Entry') }"
                :message="errors.first('Field Entry')"
                custom-class="has-text-white"
              >
                <b-input
                  v-validate="'max:256'"
                  v-model="currfield.name"
                  name="Field Entry"
                  placeholder="Name"
                />
                <b-input
                  v-validate="'max:1024'"
                  v-model="currfield.value"
                  name="Field Entry"
                  placeholder="Value"
                />
                &nbsp;&nbsp;
                <b-checkbox
                  v-model="currfield.inline"
                  custom-class="has-text-white"
                >
                  Inline Field
                </b-checkbox>
              ...
              >
                ...
                />
                &nbsp;
                <b-checkbox v-model="field.inline"> Inline </b-checkbox>
              </b-field>
              <b-field
                :type="{ 'is-danger': errors.has('Footer Text') }"
                :message="errors.first('Footer Text')"
                label="Footer"
                custom-class="has-text-white"
              >
                <b-input
            ...
            <div class="column is-half">
              <div class="box">
                <div class="content">
                  ...
                  <b-field
                    :type="{ 'is-danger': err.get('json') }"
                    :message="err.get('json')"
                  >
          ...
          <button class="button is-success" type="submit" form="embed">
            Create
          </button>
        </form>
      </div>
