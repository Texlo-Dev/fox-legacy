    ...
    <div>
		...
		<section class="section">
			...
			<div class="container">
				...
				<p>To configure permissions in your server, you can make use of the <strong class='has-text-white'>setperm</strong> command. You will need to have the <strong class='has-text-white'>core.manageperm</strong> permission to do this.</p>
				<br>
				<div align="left">
					<img src="https://s22.postimg.cc/87ex1yf0x/setpermwk.png">
				</div>
				<br>
				<p>Let's break down the setperm command.</p>
				<p>
					<strong class='has-text-white'>scope</strong> - Who or what you want to set the permission for. As an example, we'll use a role.
				</p>
				<br>
				...
				<br>
				<p>
					Our final command should look like this: <strong class='has-text-white'>setperm role mod.kickboot true @ExampleRole</strong>.
				</p>
...
export default {
    ...
    async asyncData({ params }) {
        const permissions = await API.permission();
        return {
            permissions
        }
    }
