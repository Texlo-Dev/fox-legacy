      ...
      let output = `
                ...
                My current command format for ${
                  message.guild
                    ...
                    : "this DM"
                } is \`${prefix}<commandname>\`.
                If you'd like to learn more about one of my commands, just type \`${prefix}help <commandname>\`.
    
                [Add me to your server!](https://mrfoxbot.xyz/servers) | [Offical ${
                  this.client.user.username
                } server](https://discord.gg/DfsqmaV) | [Support us on Patreon!](https://www.patreon.com/user?u=7413177)
      ...
      if (command) {
        ...
        const embed: MessageEmbed = new MessageEmbed()
          ...
          .setColor(this.client.brandColor).setDescription(`
                        ...
                        **Category:** ${this.client.capitalizeStr(
                          command.category
                        )}
