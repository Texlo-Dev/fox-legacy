...
export default class FoxCommand extends Command {
  ...
  public async run(message: FoxMessage, args: string[]): Promise<void> {
    ...
    const paginated: any = FoxClient.paginate(
      message.guild.banking.shopItems.sort((a, b) => a.price > b.price),
      page,
      10
    );
    ...
    message.send(
      ...
      new Embed()
        ...
        .setAuthor(
          `Welcome to ${
            message.guild.banking.shopName
          }! Here are your available items for purchase.`,
                    ...
                    ${
                      paginated.maxPage > 1
                        ? `\nType \`${
                          ...
                          }shop [pagenumber]\` to see a specific page.`
                        : "".trim()
                    }`
        )
